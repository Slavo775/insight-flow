...
- [ ] `agents.custom` entries produce `.claude/commands/<name>.md` skill files
...
- [ ] Run `insight-flow init` with `agents.custom: [{name: "deploy-check", ...}]` → `.claude/commands/deploy-check.md` exists
