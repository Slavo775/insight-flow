---
title: PR_API.md
sidebar_label: PR API examples
sidebar_position: 16
description: Reference copy of PR_API.md, generated from the repo root.
---
<!--
  AUTO-GENERATED FILE — DO NOT EDIT.
  Source of truth: PR_API.md at the repository root.
  Regenerate with: pnpm --dir website sync
-->

> **Reference copy.** Generated from `PR_API.md` at the repository root.
